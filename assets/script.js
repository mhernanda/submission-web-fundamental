...
const arrayLambo = [
    "assets/image/lamborghini/lamborghini_main.jpg",
    "assets/image/lamborghini/lamborgini_front.jpg",
    "assets/image/lamborghini/lamborghini_back.jpg",
    "assets/image/lamborghini/lamborghini_interior.jpg",
    "assets/image/lamborghini/lamborghini_interior2.jpeg",
];
...
nextButton.addEventListener("click", function(event) {
    ...
    if(target.classList.contains('bmw')) {
        arrayID = arrayBmw;
        counterBmw++;
        counter = counterBmw;
    }

    if(target.classList.contains('tesla')) {
        arrayID = arrayTesla;
        counterTesla++;
        counter = counterTesla;
    }
    
    if(target.classList.contains('lambo')) {
        arrayID = arrayLambo;
    }
    
    if(target.classList.contains('nissan')) {
        arrayID = arrayNissan;
    }

    if(target.classList.contains('bugatti')) {
        arrayID = arrayBugatti;
    }

    if(counter === arrayID.length) {
        counter = 0;
    }

    slideShowNode.setAttribute("src", arrayID[counter]);
});
